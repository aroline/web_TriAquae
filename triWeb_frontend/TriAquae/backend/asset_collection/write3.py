...
from  TriAquae.hosts.models import Devinfo,Check_Devinfo
#import db_connector
...
for i in os.listdir(here):
	...
	hostname_check = Devinfo.objects.filter(Triaquae_Hostname=Triaquae_Hostname)
	...
	if  len(hostname_check) < 1:
		...
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Device_Type', Old_Value=Device_Type, New_Value=receive_json['Device_Type'] )
		insert_check_Check_Devinfo.save()	    
	    if Device_Model <> receive_json['Device_Model']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Device_Model', Old_Value=Device_Model, New_Value=receive_json['Device_Model'] )
		insert_check_Check_Devinfo.save()
	    if Device_Sn <> receive_json['Device_Sn']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Device_Sn', Old_Value=Device_Sn, New_Value=receive_json['Device_Sn'] )
		insert_check_Check_Devinfo.save()			
	    if System_Kernel <> receive_json['System_Kernel']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='System_Kernel', Old_Value=System_Kernel, New_Value=receive_json['System_Kernel'] )
		insert_check_Check_Devinfo.save()			
	    if Ethernet_Interface.encode('utf-8') <> str(Ethernet_Interface_list):
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Ethernet_Interface', Old_Value=Ethernet_Interface, New_Value=Ethernet_Interface_list )
		insert_check_Check_Devinfo.save()		
	    if Memory_Slots_Number <> receive_json['Memory_Slots_Number']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Memory_Slots_Number', Old_Value=Memory_Slots_Number, New_Value=receive_json['Memory_Slots_Number'] )
		insert_check_Check_Devinfo.save()
	    if Memory_Slots_All.encode('utf-8') == 'Null':
		Memory_Slots_All = str([])
		if Memory_Slots_All <> str(Memory_Slots_All_list):
		    insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Memory_Slots_All',New_Value=Memory_Slots_All_list )
		    insert_check_Check_Devinfo.save()		    
	    elif Memory_Slots_All.encode('utf-8') <> str(Memory_Slots_All_list):
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Memory_Slots_All', Old_Value=Memory_Slots_All, New_Value=Memory_Slots_All_list )
		insert_check_Check_Devinfo.save()		
	    if Physical_Memory <> receive_json['Physical_Memory']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Physical_Memory', Old_Value=Physical_Memory, New_Value=receive_json['Physical_Memory'] )
		insert_check_Check_Devinfo.save()			
	    if Logical_Cpu_Cores <> receive_json['Logical_Cpu_Cores']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Logical_Cpu_Cores', Old_Value=Logical_Cpu_Cores, New_Value=receive_json['Logical_Cpu_Cores'] )
		insert_check_Check_Devinfo.save()		
	    if Physical_Cpu_Cores <> receive_json['Physical_Cpu_Cores']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Physical_Cpu_Cores', Old_Value=Physical_Cpu_Cores, New_Value=receive_json['Physical_Cpu_Cores'] )
		insert_check_Check_Devinfo.save()				
	    if Physical_Cpu_Model <> receive_json['Physical_Cpu_Model']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Physical_Cpu_Model', Old_Value=Physical_Cpu_Model, New_Value=receive_json['Physical_Cpu_Model'] )
		insert_check_Check_Devinfo.save()		
	    if Physical_Cpu_MHz.encode('utf-8') <> str(Physical_Cpu_MHz_list):
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Physical_Cpu_MHz', Old_Value=Physical_Cpu_MHz, New_Value=Physical_Cpu_MHz_list)
		insert_check_Check_Devinfo.save()		
	    if System_Version <> str(receive_json['System_Version']):
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='System_Version', Old_Value=System_Version, New_Value=receive_json['System_Version'] )
		insert_check_Check_Devinfo.save()
	    if Hard_Disk <> str(Hard_Disk_list):
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='Hard_Disk', Old_Value=Hard_Disk, New_Value=Hard_Disk_list )
		insert_check_Check_Devinfo.save()			
	    if System_Ip.encode('utf-8') <> str(System_Ip_list):
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='System_Ip', Old_Value=System_Ip, New_Value=System_Ip_list )
		insert_check_Check_Devinfo.save()		
	    if System_Mac.encode('utf-8') <> str(System_Mac_list):
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='System_Mac', Old_Value=System_Mac, New_Value=System_Mac_list)
		insert_check_Check_Devinfo.save()			
	    if System_Hostname <> receive_json['System_Hostname']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='System_Hostname', Old_Value=System_Hostname, New_Value=receive_json['System_Hostname'] )
		insert_check_Check_Devinfo.save()			
	    if System_Hostid <> receive_json['System_Hostid']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='System_Hostid', Old_Value=System_Hostid, New_Value=receive_json['System_Hostid'] )
		insert_check_Check_Devinfo.save()			
	    if System_Swap <> receive_json['System_Swap']:
		insert_check_Check_Devinfo = Check_Devinfo(Triaquae_Hostname= Triaquae_Hostname, Change_Type='System_Swap', Old_Value=System_Swap, New_Value=receive_json['System_Swap'] )
		insert_check_Check_Devinfo.save()	
